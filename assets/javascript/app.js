$(document).ready(function() {
    ...
    $(".start").on("click", function() {
      ...
      //NOT WORKING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      // number is always 5 if you see the console...so this if statement will never run since 5<1 is false
      console.log(number);
      if (number < 1) {
        $("#q1oot").show();
        $(".question1").hide();
    ...
    //q3 right asnwer shows happy MJ with 2 sec timer to show game over
    ...
    // q3 wrong answers will show angry mj with 2 sec timer to show game over
